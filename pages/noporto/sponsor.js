        ...
        >
          <Stack>
            ...
            <form display={'flex'} flexDirection={'column'} onSubmit={handleSubmit(onSubmit)}>
              ...
              <Flex justifyContent={'space-between'} mt={2} flexDirection={['column', 'column', 'row', 'row']}>
                <Box width={'100%'} mr={2} ml={2}>
                  <FormLabel textColor={'black'} htmlFor='soal3'>Apabila Anda terpilih menjadi anggota divisi sponsor, bagaimana strategi Anda untuk menggaet target perusahaan agar mau bergabung menjadi sponsor dari MAXIMA 2022?</FormLabel>
