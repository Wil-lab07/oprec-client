        ...
        >
          <Stack>
            ...
            <form display={'flex'} flexDirection={'column'} onSubmit={handleSubmit(onSubmit)}>
              ...
              <Flex justifyContent={'space-between'} mt={2} flexDirection={['column', 'column', 'row', 'row']}>
                <Box width={'100%'} mr={2} ml={2}>
                  <FormLabel textColor={'black'} htmlFor='soal3'>Sebagai divisi yang akan mengkonsepkan jalannya Maxima, buatlah konsep rangkaian acara Maxima 2022 mulai dari HoME, STATE, dan Malam Puncak versimu sendiri secara ringkas!</FormLabel>
