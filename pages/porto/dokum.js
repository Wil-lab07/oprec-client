  ...
  return (
    <>
        <Head>
            ...
            <link rel="icon" href="/Logo_MXM.png"></link>
        </Head>
    <Flex
      height={'100vh'}
      width={'100%'}
        ...
        >
          <Stack>
            ...
            <form display={'flex'} flexDirection={'column'} onSubmit={handleSubmit(onSubmit)}>
              ...
              {/* <Flex justifyContent={'space-between'} mt={2} flexDirection={['column', 'column', 'row', 'row']}>
                <Box width={'100%'} mr={2} ml={2}>
                  <FormLabel textColor={'black'} htmlFor='soal3'>Portofolio</FormLabel>
                  <Textarea {...register('soal3')} type={'text'} name='soal3' _placeholder={{color: 'darkgray'}} bgColor={'gray.200'} textColor={'black'}/>
                </Box>
              </Flex> */}
              <Flex justifyContent={'space-between'} mt={2} flexDirection={['column', 'column', 'row', 'row']}>
                <Box width={'100%'} mr={2} ml={2}>
                  <FormLabel textColor={'black'} htmlFor='portofolio'>
                    HARAP PILIH SALAH SATU! <br></br><br></br>
                    Portofolio Foto: <br></br>1. Mengirimkan 1 foto human interest <br></br>
2. Mengirimkan 1 foto event/ stage <br></br>
3. Mengirimkan 2 foto bebas terbaikmu <br></br>
4. Mengirimkan 2 foto dari Aftermovie MAXIMA 2021 (Buka Aftermovie MAXIMA 2021 di Youtube MaximaUMN, ambil 2 foto virtual terbaik dan terkreatif) <br></br>
5. Mengirimkan daftar gears & equipments melalui https://kit.co/ . Link tersebut ditaruh di Word/PDF dan disertakan di Google Drive portofolio. <br></br>
Catatan: 
Kumpulkan semua file tersebut ke dalam 1 Folder Google Drive dengan judul “FOTO_NAMA_ANGKATAN” dan share folder secara publik ke email maxima@umn.ac.id <br></br>
<br></br>Portofolio Video: <br></br> 1. Mengirimkan portofolio video terbaikmu  dengan durasi 3 - 5 menit.
<br></br>2. Mengirimkan portofolio showreel dengan durasi 3 - 5 menit. 
<br></br>3. Mengirimkan daftar gears & equipments lewat https://kit.co/ . Link tersebut ditaruh di Word/PDF dan disertakan di Google Drive portofolio.
<br></br>4. Bedah secara GARIS BESAR video Highlight (Instagram @maximaumn) dan Aftermovie MAXIMA 2021 (Youtube MaximaUMN) dilihat dari teknis, baik videografi maupun editing dalam bentuk PDF dengan maksimal 500 kata.
<br></br>Catatan: Kumpulkan semua file tersebut ke dalam 1 Folder Google Drive dengan judul “VIDEO_NAMA_ANGKATAN” dan share folder secara publik ke email maxima@umn.ac.id</FormLabel>
              ...
              <Flex mt={5}>
                ...
                <Box>
                  <Link href='/divisi'><Button w={20} textColor= 'white' bgColor={'gray.500'} _hover={{bgColor: "Black"}}>Back</Button></Link>
                </Box>
              </Flex>
            </form>
          </Stack>
