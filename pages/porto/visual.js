        ...
        >
          <Stack>
            ...
            <form display={'flex'} flexDirection={'column'} onSubmit={handleSubmit(onSubmit)}>
              ...
              <Flex justifyContent={'space-between'} mt={2} flexDirection={['column', 'column', 'row', 'row']}>
                <Box width={'100%'} mr={2} ml={2}>
                  <FormLabel textColor={'black'} htmlFor='soal3'>Mengapa kamu memilih divisi visual?</FormLabel>
                  <Textarea {...register('soal3')} type={'text'} name='soal3' _placeholder={{color: 'darkgray'}} bgColor={'gray.200'} textColor={'black'}/>
                </Box>
              </Flex>
              <Flex justifyContent={'space-between'} mt={2} flexDirection={['column', 'column', 'row', 'row']}>
                <Box width={'100%'} mr={2} ml={2}>
                  <FormLabel textColor={'black'} htmlFor='portofolio'>Kirimkan portofolio berisi karya-karya desain terbaikmu dalam bentuk pdf.
Lebih diutamakan jenis karya desain grafis seperti social media design, branding, ataupun ilustrasi vektor.</FormLabel>
